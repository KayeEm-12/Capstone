...
<div class="order-container">
    <h2 style="text-align: center;">User's Order</h2>
    <div class="status">
        <a href="view_order.php?order_status=Pending">Pending</a> |
        <a href="view_order.php?order_status=To%20Ship">To Ship</a> |
        <a href="view_order.php?order_status=To%20Receive">To Receive</a> |
        <a href="view_order.php?order_status=Completed">Completed</a>
    </div>
