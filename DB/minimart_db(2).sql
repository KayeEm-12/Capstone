...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2024 at 05:57 PM
...
INSERT INTO `orders` (`order_id`, `date_ordered`, `total_price`, `status`, `date_received`, `address_id`, `user_id`) VALUES
(1, '2024-03-01 07:44:44', '400.00', 'Pending', NULL, 3, 3),
(2, '2024-03-03 16:52:12', '113.75', 'Pending', NULL, 15, 9),
(3, '2024-03-03 16:56:46', '134.25', 'Pending', NULL, 15, 9),
(4, '2024-03-03 17:00:10', '75.50', 'Pending', NULL, 15, 9);
...
(2, 4809010626332, 'Lemon Square Cheese cake 10x30g', 'Cheese Cake', 75.50, 19, 'cheese-cake.png', 2),
(3, 5449000256805, 'Coke Mismo', 'Coke Mismo', 200.00, 17, 'coke_mismo.png', 1),
...
(10, 4807770270017, 'Lucky me instant noodles Beef 55g', 'LM Beef', 8.75, 0, 'lucky_me_beef.png', 4),
...
(14, 4807770272554, 'Lucky Me Pancit Canton Sweet&Spicy', 'Canton Sweet and Spicy', 14.00, 5, 'P.C._sweet.png', 4),
...
(17, 72810293583, 'Ligo Sardines in Tomato Sauce', 'Ligo Green', 24.50, 1, 'ligo-green.png', 3),
(18, 748485801728, 'Lucky 7 Carne Norte 150g', 'Lucky7 150g', 21.95, 15, 'lucky7-150g.png', 3),
(19, 857451000307, 'Mega Sardines in Tomato Sauce', 'Mega Green', 24.50, 12, 'mega-green.png', 3),
(20, 4801981118519, 'Royal Mismo', 'Royal Mismo', 200.00, 17, 'royal_mismo.png', 1),
...
(9, 'Jerwin', 'Premacio', '9659669917', 'Jawin', 'wen@gmail.com', '$2y$10$N4kMWFj6VGTveFEI2lTkluRY.A2NhVZn7vSezNEyNPmwvO6yZgDFC', 'Jawin#27', 'Customer', 15);
...
--
ALTER TABLE `orders_details`
  MODIFY `orders_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
