...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2024 at 02:41 AM
...
(25, '2024-04-19 10:07:37', '1050.00', 34, 27, 'Pending', 'pickup', '2024-04-19 16:07:37'),
(26, '2024-04-19 16:01:25', '1011.00', 39, 31, 'Pending', 'delivery', '2024-04-19 22:01:25');
...
(1, 4800163000048, 'Ligo Sardines in Tomato with chilli 155g ', 'Ligo Red', 24.50, 27.00, 60, 'ligo-red.png', 3),
(2, 4809010626332, 'Lemon Square Cheese cake 10x30g', 'Cheese Cake', 75.50, 85.00, 0, 'cheese-cake.png', 2),
(3, 5449000256805, 'Coke Mismo', 'Coke Mismo', 200.00, 210.00, 0, 'coke_mismo.png', 1),
(4, 4800361339186, 'Nescafe Classic Instant Coffee 23g', 'Nescafe 23g', 20.50, 23.00, 88, 'nescafe_23g.png', 5),
(5, 4807770272202, 'Lucky me instant noodles Chicken 55g', 'LM Chicken', 8.75, 11.00, 77, 'LM_chicken.png', 4),
(6, 4806504710126, 'Mega Sardines in Tomato Sauce with Chili 155g,', 'Mega Red', 24.50, 27.00, 22, 'mega-red.png', 3),
(7, 4800361393645, 'Nescafe Classic Instant Coffee 46g', 'Nescafe 46g', 40.00, 45.00, 6, 'nescafe_46g.png', 5),
(8, 4800110026497, 'Homi Instant Mami Noodles Beef Brisket 55g', 'HoMi Beef', 8.50, 10.00, 10, 'Homi_Beef.png', 4),
(9, 4800110025995, 'Homi Instant Mami Noodles Chicken & Garlic 55g', 'HoMi Chicken', 8.50, 10.00, 10, 'Homi_Chicken.png', 4),
...
(12, 14800016057073, 'C2 Solo Green Tea Apple 230mlx24', 'C2 Apple', 310.00, 320.00, 0, 'c2_apple.png', 1),
...
(16, 4800092110528, 'Rebisco Hansel Chocolate Sandwich 32gx10s', 'Hansel Choco', 60.00, 65.00, 10, 'hansel-choco.png', 2),
...
(20, 4801981118519, 'Royal Mismo', 'Royal Mismo', 200.00, 210.00, 7, 'royal_mismo.png', 1),
(21, 4801981118588, 'Sprite Mismo', 'Sprite Mismo', 200.00, 210.00, 5, 'sprite_mismo.png', 1),
...
(26, 748485801469, 'Lucky7 Carne Norte 100g', 'Lucky7 100g', 16.50, 20.00, 15, 'Lucky7_small.png', 3),
...
(29, 4800092110511, 'Hansel Milk Sandwich 32gx10s', 'Hansel Milk', 60.00, 65.00, 10, 'Hansel_milk.png', 2),
(30, 4800092118777, 'Hansel Milky Strawberry Sandwich 32gx10s', 'Hansel Strawberry ', 60.00, 65.00, 10, 'Hansel_Pink.png', 2);
...
--
ALTER TABLE `orders_details`
  MODIFY `orders_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
